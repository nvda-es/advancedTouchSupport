...
addon_info = AddonInfo(
	...
	addon_name="advancedTouchSupport",
	# Add-on summary/title, usually the user visible name of the add-on
	# Translators: Summary/title for this add-on
	# to be shown on installation and add-on information found in add-on store
	addon_summary=_("Advanced touch support"),
	# Add-on description
	# Translators: Long description to be shown for this add-on on add-on information from add-on store
	addon_description=_("""This add-on allows you to configure advanced features of your touch screen so you can have a better touch interaction. Currently, only the minimum flick distance can be changed. Open NVDA settings dialog and look for the advanced touch support category."""),
	# version
	...
	addon_url="https://github.com/nvda-es/advancedTouchSupport",
	# URL for the add-on repository where the source code can be found
	addon_sourceURL="https://github.com/nvda-es/advancedTouchSupport",
